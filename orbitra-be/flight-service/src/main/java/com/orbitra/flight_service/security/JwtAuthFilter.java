...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (jwtService.isTokenValid(token)) {
            ...
            // Extra "PARTNER_<type>" authority (e.g. PARTNER_FLIGHT) - role
            // alone (PARTNER) can't distinguish a flight partner from a hotel
            // partner, same reasoning as hotel-service's copy of this filter.
            if (partnerType != null) {
            ...
            // ownership checks compare against Flight.ownerId.
        ...
        // the actual reject-or-allow decision. Note: like hotel-service's
