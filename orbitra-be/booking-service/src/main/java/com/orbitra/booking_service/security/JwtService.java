...
public class JwtService {
    ...
    // The only claim this service's authorization actually depends on
    // (every route requires ROLE_TRAVELER) - unlike hotel/flight-service,
    // this service has no partner-facing routes.
